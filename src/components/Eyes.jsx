...
function Eyes() {
  ...
  return (
    <div className='eyes w-full h-screen overflow-hidden'>
        ...
        <h1 className=' absolute w-full font-bold text-zinc-800 text-7xl top-[170px]  left-1/2 -translate-x-1/2 -translate-y-1/2 leading-none tracking-tighter uppercase'>PLAY </h1>
