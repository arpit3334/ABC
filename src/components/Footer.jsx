...
function Footer() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed='.9' className='w-full h-screen flex bg-zinc-300 p-20 font-["Founders Grotesk"]'>
        <div className='w-1/2 h-full flex flex-col justify-between  font-bold'>
            <div className='heading'>
                <h1 className='-mb-6 text-8xl text-zinc-900  leading-none tracking-tighter'>EYE-</h1>
                <h1 className='text-8xl text-zinc-900  leading-none tracking-tighter'>OPENING</h1>
            </div>
            <div className='w-32 px-5 py-3 py-b-4 bg-zinc-900 rounded-full border-2'><svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='w-1/2'>
            <div className='heading '>
                <h1 className='-mb-6 text-8xl text-zinc-900 font-bold leading-none tracking-tighter'>PRESENTATIONS</h1>
                <div className='details font-["Neue Montreal"] my-[50vh] text-zinc-900 '>
